...
import com.example.allvideodownloaderrevolt.act.SplashScreenAct
...
class AVDApplicationClass : Application() {
    override fun onCreate() {
        super.onCreate()
        application = this@AVDApplicationClass
    ...
    companion object {
        var application: AVDApplicationClass? = null
        val appContext: Context?
            get() {
                if (application == null) {
                    application = AVDApplicationClass()
                }
                return application
            }
    }
