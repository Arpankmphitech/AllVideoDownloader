...
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getEncryptionKey(
        JNIEnv *env,
        jclass clazz) {
...
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getMoreAppApi(
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getLoginApi(
        JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getHeader(
        JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getCallEnd(
        JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getTwitterApi(
        JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getToken(
        JNIEnv *env, jclass clazz) {
...
Java_com_example_allvideodownloaderrevolt_commonClass_Constant_getUrl(JNIEnv *env, jobject thiz) {
