...
public class AllNativeAdsFirstLoadDisplayAds {

    private static AllNativeAdsFirstLoadDisplayAds mInstance;
    private final String TAG = "Brijali Natvi Fb Ads";
    MyCallback myCallback;
    MyCallback myCallbackDisplay;
    NativeAd nativeAdsFb;
    NativeBannerAd nativeBannerAd;

    LinearLayout adView;
    ArrayList<View> viewArrayList = new ArrayList<>();
    com.google.android.gms.ads.nativead.NativeAd googlenativeAd;
    ...
    public static AllNativeAdsFirstLoadDisplayAds getInstance() {
        if (mInstance == null) {
            mInstance = new AllNativeAdsFirstLoadDisplayAds();
        }
        return mInstance;
    }
    ...
    public void AllNatviAdsLodRequest(final Activity activity, String AdstypeString, String AdIds, MyCallback _myCallback,
                                      ...
                                      String QurekaorPredChampType, int pos,
    ...
    public void AllNatviAdsLodRequest2(final Activity activity, String AdstypeString, String AdIds, MyCallback _myCallback,
                                       int AdsSize,
                                       NativeAdLayout FbNativAdsLayout,
                                       FrameLayout GoogleNativAds,
                                       String QurekaorPredChampType, int pos) {
    ...
    public void AllNativAdsDisplayThisAds(final Activity activity, String AdstypeString,
        ...
        Log.e("14/04/2022 Big AllNativ", "AllNativAdsDisplayThisAds call");
        Log.e("14/04/2022 Big Adst", AdstypeString);
        ...
        switch (Adstype) {
            ...
            case 1:
                ...
                if (AdsSize == 2 && nativeAdsFb != null && nativeAdsFb.isAdLoaded()) {
                    if (AdsSize == 2) {
                ...
                } else if (AdsSize == 1 && nativeBannerAd != null && nativeBannerAd.isAdLoaded()) {
                    if (AdsSize == 2) {
                        DisplayFacebookNatviCallFunction(activity, FbNativAdsLayout, AdsSize, GoogleNativAds, QurekaorPredChampType);
                    } else {
                        DisplayFacebookNativeBannerCallFunction(activity, FbNativAdsLayout, AdsSize, GoogleNativAds, QurekaorPredChampType, pos);
                    }
                } else if (googlenativeAd != null && SharedPrefrences.getAdvertiseModel(activity) != null
                        ...
                        ((SharedPrefrences.getAdvertiseModel(activity) != null && SharedPrefrences.getAdvertiseModel(activity).getG() != null
                                ...
                                || !Utils.isValidaEmptyWithZero(SharedPrefrences.getAdvertiseModel(activity).getG().getNb())))
                        )) {
                ...
                break;
            case 2:
                Log.d("05/10", "2===>Entered");
                if (googlenativeAd != null) {
                    Log.d("05/10", "2===>1");
                    DisplayGoogleAdsCallThisFunction(activity, GoogleNativAds, AdsSize, QurekaorPredChampType, pos);
                } else if (AdsSize == 2 && nativeAdsFb != null && nativeAdsFb.isAdLoaded() && SharedPrefrences.getAdvertiseModel(activity) != null
                        && !Utils.isValidatEmpty(SharedPrefrences.getAdvertiseModel(activity).getPriority())
                ...
                } else if (AdsSize == 1 && nativeBannerAd != null && nativeBannerAd.isAdLoaded() && SharedPrefrences.getAdvertiseModel(activity) != null
                        && !Utils.isValidatEmpty(SharedPrefrences.getAdvertiseModel(activity).getPriority())
                        && SharedPrefrences.getAdvertiseModel(activity).getPriority().equalsIgnoreCase("G,F")
                        &&
                        ((SharedPrefrences.getAdvertiseModel(activity) != null && SharedPrefrences.getAdvertiseModel(activity).getF() != null
                                && !Utils.isValidaEmptyWithZero(SharedPrefrences.getAdvertiseModel(activity).getF().getNb())))) {
                    Log.d("05/10", "2===>3");
    ...
    public void DisplayQurekaLoad(final Activity activity, FrameLayout googleNativAds, int adsSize,
        ...
        //Big native
          ...
          /*  View myView = LayoutInflater.from(activity)
            ...
            View myView1 = activity.getLayoutInflater().inflate(R.layout.qureka_big_native, null);
            ...
            public void onError(Ad ad, AdError adError) {
               ...
               /* if (FbNativAdsLayout != null) {
                ...
                if (SharedPrefrences.getAdvertiseModel(activity) != null && !Utils.isValidatEmpty(SharedPrefrences.getAdvertiseModel(activity).getPriority())
                    ...
                    /*GoogleNativAdsNew(activity, SharedPrefrences.getAdvertiseModel(activity).getG().getN(), AdsSize,
                            FbNativAdsLayout, GoogleNativAds, QurekaorPredChampType);*/
                } else {
    ...
    private void FacebookNativeBannerAds(final Activity activity, final String adIds,
        ...
        NativeAdListener nativeAdListener = new NativeAdListener() {
            ...
            public void onError(Ad ad, AdError adError) {
                ...
                Log.d("19/12", "snb--->" + SharedPrefrences.getAdvertiseModel(activity));
                if (SharedPrefrences.getAdvertiseModel(activity) != null && !Utils.isValidatEmpty(SharedPrefrences.getAdvertiseModel(activity).getPriority())
                        && SharedPrefrences.getAdvertiseModel(activity).getPriority().equalsIgnoreCase("F,G")
                        &&
                        ((SharedPrefrences.getAdvertiseModel(activity) != null &&
                                SharedPrefrences.getAdvertiseModel(activity).getG() != null
                                && (!Utils.isValidaEmptyWithZero(SharedPrefrences.getAdvertiseModel(activity).getG().getN())
                                || !Utils.isValidaEmptyWithZero(SharedPrefrences.getAdvertiseModel(activity).getG().getNb()))))
                ) {
//                    GoogleNativAdsNew(activity, SharedPrefrences.getAdvertiseModel(activity).getG().getN(), AdsSize, FbNativAdsLayout, GoogleNativAds, QurekaorPredChampType);
            ...
            try {
                ...
                AdLoader adLoader = builder.withAdListener(new AdListener() {
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        Log.d("15/12", "" + loadAdError.getMessage());
...
*/
    ...
    private void DisplayGoogleAdsCallThisFunction(final Activity activity, final FrameLayout googleNativAds,
        ...
        if (googlenativeAd != null) {
            ...
            Log.d("05/10", "DisplayGoogleAdsCallThisFunction--adssize--" + AdsSize);
            if (AdsSize == 1) {
                Log.d("05/10", "DisplayGoogleAdsCallThisFunction--pos--" + pos);
                if (pos == 1) {
                    adView = (NativeAdView) activity.getLayoutInflater().inflate(R.layout.google_native_layout_2, null);
...
//        com.google.android.gms.ads.nativead.MediaView mideaview = adView.findViewById(R.id.ad_media);
        // Set the media view.
...
//        });
        ...
        if (AdsSize == 1) {
//            mideaview.setVisibility(View.GONE);
        }
